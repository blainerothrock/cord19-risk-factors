...
class Cord19(LanguageModelingDataset):
    ...
    def splits(cls, text_field, root='.data', train='train_tokens.txt',
               ...
               **kwargs):
        """Create dataset objects for splits of the Cord19 dataset.
        ...
        Arguments:
            ...
            root: The root directory that the dataset's zip archive will be
                expanded into; therefore the directory in whose cord19
                subdirectory the data files will be stored.
            train: The filename of the train data. Default: 'train_tokens.txt'.
            validation: The filename of the validation data, or None to not
                load the validation set. Default: 'validation_tokens.txt'.
            test: The filename of the test data, or None to not load the test
                set. Default: 'test_tokens.txt'.
        """
    ...
    def iters(cls, batch_size=32, bptt_len=35, device=0, root='cord19_data',
              vectors=None, **kwargs):
        """Create iterator objects for splits of the Cord19 dataset.
